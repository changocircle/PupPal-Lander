...
const STEPS = [
  {
    ...
    num: 1,
    title: "Snap a photo",
    desc: "Our AI detects your puppy's breed instantly. 98% accuracy across 50+ breeds.",
  ...
  },
  {
    ...
    num: 2,
    title: "Get your plan",
    desc: "A personalized training program built for your dog's breed, age, and challenges. Grows with your puppy.",
  ...
  },
  {
    ...
    desc: "Daily exercises, AI mentor chat, health tracking, and the Good Boy Score.",
